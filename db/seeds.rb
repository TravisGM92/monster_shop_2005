...
# Users
ross = User.create!(name: 'Ross Mooney', address: '2468 S. Grant St.', city: 'Littleton', state: 'CO', zip: '80121', email: 'ross_is_cool25@turing.io', password: 'test124', role: 0)
...
dwight = User.create!(name: "Dwight Kurt Schrute III", address: "123 Beet Farm", city: "Scranton", state: "PA", zip: 18510, email: "d-money@email.com", password: "angela", role: 1)
nelcy = User.create!(name: "Nelcy Pillado", address: "123 Kedvale Ave", city: "Chicago", state: "IL", zip: 60623, email: "nelcy@email.com", password: "password", role: 1)
